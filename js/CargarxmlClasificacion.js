...
function cargarTabla(temporada) {
    ...
    $.ajax({
        type: "GET",
        url: `../xml/XML_${temporada}/clasificacion.xml`,
        dataType: "xml",
        success: function (xml) {
            // Cargar la hoja de estilo XSLT
            $.ajax({
                type: "GET",
                url: "../xml/xsl/clasificacion.xsl",
                dataType: "xml",
...
function descargarXML() {
    ...
    var archivoXML = `../xml/XML_${temporadaActual}/clasificacion.xml`;
        ...
        success: function () {
            ...
            $.ajax({
                ...
                success: function (xml) {
                    ...
                    a.href = url;
                    a.download = `clasificacion_${temporadaActual}.xml`;
